...
export const accounts = sqliteTable(
  ...
  (t) => [
    uniqueIndex('idx_accounts_wallet_hash').on(t.walletHash),
...
export const rewards = sqliteTable(
  'rewards',
  {
    ...
    fundingAmountLuna: text('funding_amount_luna'),
    feeReserveLuna: text('fee_reserve_luna'),
    transactionFeeLuna: text('transaction_fee_luna'),
    feeSlots: integer('fee_slots'),
    vaultAddress: text('vault_address'),
    vaultNetwork: text('vault_network', {
      enum: ['MainAlbatross', 'TestAlbatross'],
    }),
